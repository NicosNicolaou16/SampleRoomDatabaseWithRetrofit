...
* **Dependency Injection:** Uses **Hilt** to manage and provide dependencies across components, ensuring a modular and testable codebase.
* **Responsive UI:** Implements **Data Binding** and **View Binding** to reduce boilerplate and ensure type-safe view access.
* **Architecture:** Follows the **MVVM** pattern with a Repository to ensure a clean separation of concerns.
...
This project is built with **[Kotlin](https://kotlinlang.org/docs/getting-started.html)** and utilizes a variety of modern Android libraries:
...
- **Hilt Guide:** [Dagger.dev/Hilt](https://dagger.dev/hilt/)
